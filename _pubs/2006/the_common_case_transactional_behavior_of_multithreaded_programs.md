...
materials:
  - name: paper
    url: /pubs/the_common_case_transactional_behavior_of_multithreaded_programs/paper.pdf
    type: file-pdf
  - name: talk
    url: /pubs/the_common_case_transactional_behavior_of_multithreaded_programs/talk.pdf
    type: file-pdf
  - name: IEEE Xplore
    url: https://doi.org/10.1109/hpca.2006.1598135
    type: file-alt
tags:
  - architecture
  - parallel-compute
